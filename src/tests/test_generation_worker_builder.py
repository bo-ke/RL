...
class VllmGenerationWorkerBuilderTest(unittest.TestCase):
    ...
    def test_3_generate_empty_input(self):
        ...
        result = ray.get(
            self.worker.generate.remote(data=empty_data, greedy=True),
            timeout=10
        )
    ...
    def test_4_generate_basic(self):
        ...
        result = ray.get(
            self.worker.generate.remote(data=test_data, greedy=True),
            timeout=60
        )
    ...
    def test_5_generate_text(self):
        ...
        result = ray.get(
            self.worker.generate_text.remote(data=test_data, greedy=True),
            timeout=60
        )
